...
## Project Structure
    ...
    ├── sparkling_block_dev_93774  # Django project configurations
...
1. Clone this repo and `cd sparkling_block_dev_93774`
...
2. Clone this repo and `cd sparkling_block_dev_93774`
